const global = {
    ...
    api: {
        apiKey: '44f422c1ef9002351a81e644667e1967',
...
async function displayShowDetails() {
    ...
    <div class="details-bottom">
        <h2>Show Info</h2>
        <ul>
            <li><span class="text-secondary">Numver of Episodes:</span> ${show.number_of_episodes}</li>
...
function displayPagination() {
    ...
    // Disable pre button if on first page
